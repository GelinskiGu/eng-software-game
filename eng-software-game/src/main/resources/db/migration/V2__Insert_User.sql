...
values  ('mbailey', 'mbailey0@gmail.com', 'Maxim Bailey', '123', true, true, true, true),
        ('sdecourt1', 'sdecourt1@gmail.com', 'Stillman Decourt', '123', true, true, true, true),
        ('mfulop2', 'mfulop2@gmail.com', 'Marielle Fulop', '123', true, true, true, true);
